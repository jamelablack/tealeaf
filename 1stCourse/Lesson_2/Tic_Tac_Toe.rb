...
# square # you wouldn't want to say square is aware of position, b/c the square is no longer reusable
# 	- occupied?
# 	- mark(marker)

# game_engine #is the procedural peice to the game that will orchestrate the game
# Sequence of steps
=begin
1. Draw a board
